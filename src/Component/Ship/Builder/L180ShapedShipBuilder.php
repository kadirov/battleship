...
class L180ShapedShipBuilder extends AbstractShipBuilder
{
    /**
    ...
    public function build(DeskInterface $desk): ShipInterface
    {
        ...
        while (true) {
            ...
            $area = $this->getDeskManager()->getAreaByCoordinates($desk, $coordinateX + 1, $coordinateY + 1);
    ...
    protected function createShipMargins(ShipInterface $ship, int $coordinateX, int $coordinateY): void
    {
        ...
        // right-0
        $this->createShipMarginArea($ship, $coordinateX + 2, $coordinateY);
        ...
        // bottom-0
        $this->createShipMarginArea($ship, $coordinateX, $coordinateY + 3);
    ...
    protected function createShipArea(ShipInterface $ship, int $coordinateX, int $coordinateY): void
    {
        ...
        $this->createArea($ship->getDesk(), AreaType::INTACT, $coordinateX + 1, $coordinateY + 2, $ship);
    }
}
